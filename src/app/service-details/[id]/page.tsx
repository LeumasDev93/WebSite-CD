            ...
            <div className="flex flex-row justify-center space-x-5 mt-8">
              {visibleServices.map((service, index) => (
                <Link href={`/service-details/${service.id}`} key={index}>
                  <div className="w-80 md:w-96 h-[300px] rounded bg-white dark:bg-gray-800 shadow md:shadow-md mb-5 md:mb-0 transition-transform duration-300 transform hover:scale-110 hover:bg-blue-100 dark:hover:bg-blue-700 p-4 flex flex-col items-center">
